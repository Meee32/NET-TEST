...
public:
    ...
    enum MessageBoxFlags
    {
        ...
        MSG_WARNING = (ICON_WARNING | MODAL),
        MSG_ERROR = (ICON_ERROR | MODAL),

        BTN_MASK = (YES | OK | NO | YES/NO | CANCEL | APPLY |
                  CLOSE | OK_DEFAULT | YES_DEFAULT | NO_DEFAULT | CANCEL_DEFAULT | ICON_EXCLAMATION),
