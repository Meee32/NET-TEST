...
{
    return GetBoolArg("-testnet", false) ? 20914 : 20913;
}
...
{ //  name                      function                 safemd  unlocked  isWalletFn
  //  ------------------------  -----------------------  ------  --------  ----------
    ...
    { "getrawmempool",          &getrawmempool,          true,   false,    true },
    ...
    { "decodescript",           &decodescript,           false,  false,    true },
    { "signrawtransaction",     &signrawtransaction,     false,  false,    true },
    { "sendrawtransaction",     &sendrawtransaction,     false,  false,    true },
